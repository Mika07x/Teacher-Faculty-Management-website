...
require_once $_SERVER['DOCUMENT_ROOT'] . '\\Teacher Faculty Management website\classes\Schedule.php';
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2><i class="fas fa-home"></i> Welcome, <?php echo htmlspecialchars(SessionManager::getUsername()); ?>!</h2>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($class['classroom_location']): ?>
                                                    <br><small class="text-muted"><?php echo htmlspecialchars($class['classroom_location']); ?></small>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                        ...
                        <?php while ($announcement = $recentAnnouncements->fetch_assoc()): ?>
                            <div class="announcement-item border-bottom pb-3 mb-3">
                                <div class="d-flex justify-content-between align-items-start">
                                    <span class="badge bg-<?php echo $announcement['priority'] === 'urgent' ? 'danger' : ($announcement['priority'] === 'important' ? 'warning' : 'info'); ?> mb-1">
                                        <?php echo ucfirst($announcement['priority']); ?>
                                    </span>
                                    <small class="text-muted"><?php echo date('M j', strtotime($announcement['created_at'])); ?></small>
                                </div>
                                <h6 class="mb-1"><?php echo htmlspecialchars($announcement['title']); ?></h6>
                                <p class="mb-1 small"><?php echo htmlspecialchars(substr($announcement['content'], 0, 100)); ?><?php echo strlen($announcement['content']) > 100 ? '...' : ''; ?></p>
                                <small class="text-muted">
                                    <i class="fas fa-user"></i> <?php echo htmlspecialchars($announcement['first_name'] . ' ' . $announcement['last_name']); ?> 
