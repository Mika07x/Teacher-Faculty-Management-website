            ...
            <form method="POST" action="">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="time" class="form-control" id="start_time" name="start_time" 
                                   value="<?php echo $editSlot ? htmlspecialchars($editSlot['start_time']) : ''; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="time" class="form-control" id="end_time" name="end_time" 
                                   value="<?php echo $editSlot ? htmlspecialchars($editSlot['end_time']) : ''; ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <?php if ($action === 'edit'): ?>
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select" id="status" name="status">
                            <option value="active" <?php echo ($editSlot['status'] === 'active') ? 'selected' : ''; ?>>Active</option>
                            <option value="inactive" <?php echo ($editSlot['status'] === 'inactive') ? 'selected' : ''; ?>>Inactive</option>
                        </select>
                    </div>
                <?php endif; ?>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> <?php echo ($action === 'add') ? 'Add Time Slot' : 'Update Time Slot'; ?>
                    </button>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="time-slots.php?action=edit&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="time-slots.php?action=delete&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" 
