        ...
        <div class="card-body">
            <form method="POST" action="">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="subject_code" name="subject_code" 
                                   value="<?php echo $editSubject ? htmlspecialchars($editSubject['subject_code']) : ''; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="subject_name" name="subject_name" 
                                   value="<?php echo $editSubject ? htmlspecialchars($editSubject['subject_name']) : ''; ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="4"><?php echo $editSubject ? htmlspecialchars($editSubject['description'] ?? '') : ''; ?></textarea>
                </div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input type="text" id="searchInput" class="form-control" placeholder="Type to search by code, name, or department..." autocomplete="off">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr data-code="<?= strtolower(htmlspecialchars($row['subject_code'])) ?>"
                                    ...
                                    <td>
                                        <a href="subjects.php?action=edit&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="subjects.php?action=delete&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" 
