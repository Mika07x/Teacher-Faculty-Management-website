...
require_once $_SERVER['DOCUMENT_ROOT'] . '\Teacher Faculty Management website\classes\Classroom.php';
            ...
            <form method="POST" action="">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="room_number" name="room_number" 
                                   value="<?php echo $editClassroom ? htmlspecialchars($editClassroom['room_number']) : ''; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="room_name" name="room_name" 
                                   value="<?php echo $editClassroom ? htmlspecialchars($editClassroom['room_name']) : ''; ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" id="building" name="building">
                                ...
                                <option value="Main Building" <?php echo ($editClassroom && $editClassroom['building'] === 'Main Building') ? 'selected' : ''; ?>>Main Building</option>
                                <option value="Building A" <?php echo ($editClassroom && $editClassroom['building'] === 'Building A') ? 'selected' : ''; ?>>Orange Building</option>
                                <option value="Building B" <?php echo ($editClassroom && $editClassroom['building'] === 'Building B') ? 'selected' : ''; ?>>Admin Building</option>
                                <option value="Building C" <?php echo ($editClassroom && $editClassroom['building'] === 'Building C') ? 'selected' : ''; ?>>Registrar Building</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" id="capacity" name="capacity" min="1"
                                   value="<?php echo $editClassroom ? htmlspecialchars($editClassroom['capacity']) : ''; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" id="room_type" name="room_type">
                                ...
                                <option value="lab" <?php echo ($editClassroom && $editClassroom['room_type'] === 'laboratory') ? 'selected' : ''; ?>>Laboratory</option>
                                <option value="seminar" <?php echo ($editClassroom && $editClassroom['room_type'] === 'lecture room') ? 'selected' : ''; ?>>Lecture Room</option>
                                <option value="auditorium" <?php echo ($editClassroom && $editClassroom['room_type'] === 'social hall') ? 'selected' : ''; ?>>Social Hall</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <?php if ($action === 'edit'): ?>
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select" id="status" name="status">
                            <option value="active" <?php echo ($editClassroom['status'] === 'active') ? 'selected' : ''; ?>>Active</option>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> <?php echo ($action === 'add') ? 'Add Classroom' : 'Update Classroom'; ?>
                    </button>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input type="text" id="searchInput" class="form-control" placeholder="Type to search by room number, name, building..." autocomplete="off">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr data-room="<?= strtolower(htmlspecialchars($row['room_number'])) ?>"
                                    ...
                                    <td><span class="badge badge-info"><?php echo htmlspecialchars($row['room_type']); ?></span></td>
                                    <td><?php echo htmlspecialchars($row['capacity']); ?></td>
                                    <td><?php echo htmlspecialchars($row['equipment'] ?? '-'); ?></td>
                                    <td>
                                        <span class="badge badge-<?php echo ($row['status'] === 'active') ? 'success' : ($row['status'] === 'maintenance' ? 'warning' : 'danger'); ?>">
                                            <?php echo htmlspecialchars($row['status']); ?>
                                        </span>
                                    </td>
                                    <td>
                                        <a href="classrooms.php?action=edit&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="classrooms.php?action=delete&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" 
                            ...
                            <tr id="noClassroomsRow">
                                <td colspan="8" class="text-center text-muted">No classrooms found</td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
