        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <div class="position-relative">
                    <input type="text" id="searchInput" class="form-control" placeholder="Type to search by username or email..." autocomplete="off">
                ...
                <?php if (count($students) > 0): ?>
                    ...
                    <tr data-username="<?= strtolower(htmlspecialchars($student['username'])) ?>" 
                        ...
                        <td>
                            ...
                            <a href="students.php?action=delete&id=<?= $student['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this student? This action cannot be undone.');">
...
<!-- Edit Student Modal -->
<?php if ($editStudent): ?>
<div class="modal fade show" id="editStudentModal" tabindex="-1" aria-labelledby="editStudentModalLabel" aria-hidden="true" style="display: block;">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="post">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="username" value="<?= htmlspecialchars($editStudent['username']) ?>" required>
          </div>
          <div class="mb-3">
