...
require_once $_SERVER['DOCUMENT_ROOT'] . '\Teacher Faculty Management website\classes\User.php';
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td>
                    <span class="badge badge-<?php echo ($row['status'] === 'active') ? 'success' : ($row['status'] === 'inactive' ? 'danger' : 'warning'); ?>">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <p class="form-control-plaintext"><?php echo htmlspecialchars($viewTeacher['first_name']); ?></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <p class="form-control-plaintext"><?php echo htmlspecialchars($viewTeacher['phone'] ?? '-'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <p class="form-control-plaintext"><?php echo htmlspecialchars($viewTeacher['department'] ?? '-'); ?></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Qualification</label>
                        <p class="form-control-plaintext"><?php echo htmlspecialchars($viewTeacher['qualification'] ?? '-'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <p class="form-control-plaintext"><?php echo $viewTeacher['hire_date'] ? date('F j, Y', strtotime($viewTeacher['hire_date'])) : '-'; ?></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <p class="form-control-plaintext">
                            <span class="badge badge-<?php echo ($viewTeacher['status'] === 'active') ? 'success' : ($viewTeacher['status'] === 'inactive' ? 'danger' : 'warning'); ?>">
            ...
            <div class="mb-3">
                ...
                <p class="form-control-plaintext"><?php echo $viewTeacher['bio'] ? nl2br(htmlspecialchars($viewTeacher['bio'])) : '-'; ?></p>
            </div>

            <div class="mb-3">
                <label class="form-label fw-bold">Registration Date</label>
                <p class="form-control-plaintext"><?php echo date('F j, Y g:i A', strtotime($viewTeacher['created_at'])); ?></p>
            </div>

            <div class="d-flex gap-2">
                <a href="teachers.php?action=delete&id=<?php echo $viewTeacher['id']; ?>" 
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" class="row g-3" id="searchForm">
                <div class="col-md-4">
                    <input type="text" class="form-control" name="search" id="searchInput" placeholder="Search by name, email, or department..." 
                           value="<?php echo htmlspecialchars($_GET['search'] ?? ''); ?>" autocomplete="off">
                    <div id="searchSuggestions" class="position-absolute bg-white border rounded shadow-sm" style="display: none; z-index: 1000; max-height: 300px; overflow-y: auto; width: 100%;"></div>
                </div>
                <div class="col-md-4">
