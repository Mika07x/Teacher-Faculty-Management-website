            ...
            <?php if ($currentAssignment): ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    <p class="mb-0">
                        ...
                        <strong>Room:</strong> <?php echo htmlspecialchars($currentAssignment['room_number'] . ' - ' . $currentAssignment['room_name']); ?><br>
                        <strong>Time:</strong> <?php echo htmlspecialchars($currentAssignment['start_time'] . ' - ' . $currentAssignment['end_time']); ?>
                    </p>
            ...
            <div class="row mb-4">
                <div class="col-md-6 col-lg-4">
                    <div class="stat-card">
                        ...
                        <div class="stat-number" id="scheduleCount"><?php echo htmlspecialchars($scheduleCount); ?></div>
                                    ...
                                    <ul class="list-group">
                                        <?php foreach ($todayClasses as $tc): ?>
                                            <li class="list-group-item">
                                                ...
                                                <br>
                                                <?php echo htmlspecialchars($tc['subject_name']); ?> — <small><?php echo htmlspecialchars($tc['room_number'] . ' ' . $tc['room_name']); ?></small>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                                <?php else: ?>
                            ...
                            <ul class="list-group">
                                <?php foreach ($upcomingClasses as $uc): ?>
                                    <li class="list-group-item">
                                        ...
                                        <br>
                                        <?php echo htmlspecialchars($uc['subject_name']); ?> — <small><?php echo htmlspecialchars($uc['room_number'] . ' ' . $uc['room_name']); ?></small>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        <?php else: ?>
