        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="stat-card">
                            ...
                            <div class="stat-number"><?php echo htmlspecialchars(substr($currentAssignment['subject_name'], 0, 20)); ?></div>
                    ...
                    <div class="col-md-4">
                        <div class="stat-card">
                            ...
                            <div class="stat-number"><?php echo htmlspecialchars($currentAssignment['room_number']); ?></div>
            ...
            <?php else: ?>
                ...
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    ...
                    <p>You do not have a class scheduled at this time. Check your full schedule for upcoming classes.</p>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($next['room_number'] . ' - ' . $next['room_name']); ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Day:</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($next['start_time'] . ' - ' . $next['end_time']); ?></td>
                                    </tr>
                                </table>
                                <?php
                            } else {
