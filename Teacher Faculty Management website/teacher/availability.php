    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="POST" class="row g-3">
                ...
                <div class="col-12">
                    <button type="submit" name="set_availability" class="btn btn-primary">Save Availability</button>
                </div>
            </form>
        </div>
    </div>
                        ...
                        <?php foreach ($days as $d): ?>
                            <tr>
                                ...
                                <?php foreach ($slotIds as $sid): ?>
                                    ...
                                    <td class="text-center <?php echo ($st === 'available') ? 'table-success' : 'table-warning'; ?>">
