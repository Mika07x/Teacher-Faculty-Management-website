                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            if ($userTeacherId) {
                                ...
                                if ($current) {
                                    ?>
                                    <p><strong>Subject:</strong> <?php echo htmlspecialchars($current['subject_name']); ?></p>
                                    <p><strong>Room:</strong> <?php echo htmlspecialchars($current['room_number'] . ' - ' . $current['room_name']); ?></p>
                                    <p><strong>Time:</strong> <?php echo htmlspecialchars($current['start_time'] . ' - ' . $current['end_time']); ?></p>
