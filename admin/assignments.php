            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input type="text" id="searchInput" class="form-control" placeholder="Type to search by professor, subject, department..." autocomplete="off">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr data-teacher="<?= strtolower(htmlspecialchars($teacherName)) ?>"
                                    ...
                                    <td><strong><?php echo htmlspecialchars($teacherName); ?></strong><br><small class="text-muted"><?php echo htmlspecialchars($row['department']); ?></small></td>
                                    <td><?php echo htmlspecialchars($row['subject_name']); ?><br><small class="text-muted"><?php echo htmlspecialchars($row['subject_code']); ?></small></td>
                                    ...
                                    <td>
                                        <a href="assignments.php?action=delete&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" 
