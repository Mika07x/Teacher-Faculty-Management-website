                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr data-room="<?= strtolower(htmlspecialchars($row['room_number'])) ?>"
                                ...
                                <td><span class="badge badge-info text-capitalize"><?php echo htmlspecialchars($row['room_type']); ?></span></td>
                                <td><?php echo htmlspecialchars($row['capacity']); ?></td>
                                <td><span class="badge badge-success text-capitalize"><?php echo htmlspecialchars($row['status'] ?? '-'); ?></span></td>
                        ...
                        <tr id="noClassroomsRow">
                            <td colspan="9" class="text-center text-muted">No classrooms found</td> <!-- updated colspan -->
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
