...
// Ensure we're in admin context and user is admin
...
// Fetch teacher info if admin is a teacher (admin profile management)
$teacher = null;
    ...
    if (empty($first_name) || empty($last_name) || empty($email)) {
        ...
        if (empty($error)) {
            ...
            if ($teacher) {
                ...
                $update_teacher = $conn->prepare("INSERT INTO teachers (user_id, first_name, last_name, phone, department) VALUES (?, ?, ?, ?, ?)");
                $update_teacher->bind_param('issss', $user_id, $first_name, $last_name, $phone, $department);
            }
...
<head>
    ...
    <title>Edit Teacher Profile - Admin</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container mt-4">
            <h2>Edit Admin Teacher Profile</h2>
            <?php if ($message): ?>
