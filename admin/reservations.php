                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php while ($r = $pending->fetch_assoc()): ?>
                            <tr>
                                <td><?php echo $r['id']; ?></td>
                                <td><?php echo htmlspecialchars($r['first_name'] . ' ' . $r['last_name'] . ' (' . $r['username'] . ')'); ?></td>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#rejectModal<?php echo $r['id']; ?>">Reject</button>
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-header">
                                            <h5 class="modal-title">Reject Reservation #<?php echo $r['id']; ?></h5>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php while ($a = $all->fetch_assoc()): ?>
                            <tr>
                                <td><?php echo $a['id']; ?></td>
                                <td><?php echo htmlspecialchars($a['first_name'] . ' ' . $a['last_name'] . ' (' . $a['username'] . ')'); ?></td>
